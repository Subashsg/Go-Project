...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	err := c.ShouldBindUri(&input) // ShouldBindUri is input.id
...
func (h *campaignHandler) CreateCampaign(c *gin.Context) {
	...
	currentUser := c.MustGet("currentUser").(user.User) // currentUser is the key here MustGet look for value if not found return the error.
